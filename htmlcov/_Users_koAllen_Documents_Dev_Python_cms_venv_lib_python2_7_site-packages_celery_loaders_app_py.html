...
<head>
    ...
    <title>Coverage for /Users/koAllen/Documents/Dev/Python/cms/venv/lib/python2.7/site-packages/celery/loaders/app.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/Users/koAllen/Documents/Dev/Python/cms/venv/lib/python2.7/site-packages/celery/loaders/app.py</b> :
...
<p id="t3" class="pln"><span class="str">&nbsp; &nbsp; celery.loaders.app</span><span class="strut">&nbsp;</span></p>
<p id="t4" class="pln"><span class="str">&nbsp; &nbsp; ~~~~~~~~~~~~~~~~~~</span><span class="strut">&nbsp;</span></p>
<p id="t5" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t6" class="pln"><span class="str">&nbsp; &nbsp; The default loader used with custom app instances.</span><span class="strut">&nbsp;</span></p>
...
<p id="t11" class="stm run hide_run"><span class="key">from</span> <span class="op">.</span><span class="nam">base</span> <span class="key">import</span> <span class="nam">BaseLoader</span><span class="strut">&nbsp;</span></p>
<p id="t12" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t13" class="stm run hide_run"><span class="nam">__all__</span> <span class="op">=</span> <span class="op">[</span><span class="str">&#39;AppLoader&#39;</span><span class="op">]</span><span class="strut">&nbsp;</span></p>
<p id="t14" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t15" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t16" class="stm run hide_run"><span class="key">class</span> <span class="nam">AppLoader</span><span class="op">(</span><span class="nam">BaseLoader</span><span class="op">)</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
